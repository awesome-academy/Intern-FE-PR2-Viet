...
import { createProduct, getSidebar, updateProduct, getProductDetail } from "../../../../../redux/actions";
                    ...
                    <div className="addProductAdmin__container container">
                        ...
                        <Formik
                            initialValues={{
                                ...
                                shortDesc:
                                    location.pathname.indexOf(`edit`) !== -1
                                        ? productDetail?.product?.shortDesc
                                        : "",
                                tagId:
                                    location.pathname.indexOf(`edit`) !== -1
                                        ? productDetail?.product?.tagId
                                        : "",
                                newPrice:
                                    location.pathname.indexOf(`edit`) !== -1
                                        ? productDetail?.product?.newPrice
                                        : "",
                                oldPrice:
                                    location.pathname.indexOf(`edit`) !== -1
                                        ? productDetail?.product?.newPrice
                            ...
                            validationSchema={Yup.object({
                                ...
                                ...(location.pathname.indexOf(`edit`) !== -1 && {
                                    oldPrice: Yup.string()
                                        .required(t("validate.price.required"))
                                        .matches(
                                            /(^(1|2|3|4|5|6|7|8|9)+[0-9]{4,8}$)/,
                                            t("validate.price.regex")
                                        ),
                                }),
                                                ...
                                                <Field
                                                    ...
                                                    render={(FieldProps) => (
                                                        <Select
                                                            ...
                                                            placeholder={t(
                                                                "admin.products.Select product line"
                                                            )}
                                                            onChange={(value) =>
