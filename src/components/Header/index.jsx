      ...
      <section className="header__main">
        <div className="container header__main--container">
          ...
          <div className="header__widget">
            <div className="header__widget--item icon-hamburger " onClick={() => setShowNavbar(true)}>
              <GiHamburgerMenu />
            </div>
            <div className="header__widget--account">
              ...
              <div className="header__widget--account-content">
                ...
                <p>
                  <span onClick={() => history.push("/register")} className="header__widget--account-text">
                    {t("Register")}
                  </span>
                  <span onClick={() => history.push("/login")} className="header__widget--account-text">
                    {t("Login")}
                  </span>
                </p>
              </div>
