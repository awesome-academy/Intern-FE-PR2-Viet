    ...
    dropdownData: [
      {
        id: 1,
        name: "Fresh food",
        data: ["Fruit & Nut", "Snack Foods", "organics Nut Gifts", "Non-Dairy", "Delicius Chiken Hotdogs"],
      },
      {
        id: 2,
        name: "MixedFruits",
    ...
    dropdownData: [
      {
        ...
        name: "Bestseller",
        img:
          "https://cdn.shopify.com/s/files/1/0412/8151/9765/collections/banner4_560x350_crop_center.jpg?v=1595936653",
      },
      {
        id: 2,
        name: "Special Product",
        img:
          "https://cdn.shopify.com/s/files/1/0412/8151/9765/collections/banner6_560x350_crop_center.jpg?v=1595936651",
      },
      {
        id: 3,
        name: "Featured Product",
        img:
          "https://cdn.shopify.com/s/files/1/0412/8151/9765/collections/banner5_19e6fd2c-70b2-459d-b4d5-d7680262856a_560x350_crop_center.jpg?v=1595936691",
      },
    ],
  },
  {
...
const Navbar = ({ setShowNavbar, showNavbar }) => {
  ...
  const renderNavbar = (data) => {
    return data.map((item, index) => (
      ...
      >
        <a href="#" className="navbar__item--link" onClick={() => handelNavbarClick(item.id, item.path)}>
          {" "}
          {!item.dropdownData ? (
            t(item.name)
          ) : (
        ...
        {item.dropdownData && (
          <ul
            className={`${
              !showNavbar
                ? "dropdown"
                : `dropdown-mobile ${isActiveMobile.idParentNavbar === item.id && "dropdown-mobile--active"}`
