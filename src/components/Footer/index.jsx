...
const Footer = () => {
  ...
  const dataList = [
    ...
    },
    {
      id: 3,
      title: "Privacy_Terms",
      list: ["Payment policy", "Privacy policy", "Return policy", "shipping policy", "Terms & Conditions"],
    },
    {
      id: 4,
      title: "My_Account",
              ...
              <Row>
                <Col xs={24} sm={24} md={8} lg={8} xl={8}>
                  <div className="info__logo">
                    ...
                    <p>
                      Lorem Ipsum, You Need To Be Amet Embarrassing Passage Of Lorem Ipsum, You Need To Be
                      Amet Embarrassing
                    </p>
                  </div>
                </Col>
